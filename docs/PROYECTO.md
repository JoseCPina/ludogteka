...
- **Pendiente de captura real, no simulable por mí**: dirección de la base de la camioneta, dirección de Ludogteka, tramos de tarifa por km (precio real), y la llave de Google Maps para producción — sin estos tres el cotizador corre en modo simulación indefinidamente.
