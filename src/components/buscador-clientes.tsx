 ...
 * pantalla) o `hrefDe` (elegir es navegar, p. ej. a los pases de ese
 * cliente). Las filas vienen de src/lib/clientes/buscables.ts.
 */
    ...
    <div className="flex flex-col gap-4">
      ...
      {(hayBusqueda || listarSinBusqueda) && (
        <div className="overflow-hidden rounded-lg border border-n-200 bg-white">
          {visibles.length === 0 ? (
            <p className="p-6 text-center text-n-600">{vacio}</p>
          ) : (
